...
A REST API example built with [Elysia](https://elysiajs.com/) — a TypeScript framework for Bun focused on ergonomics, performance, and end-to-end type safety.
...
```bash
git clone https://github.com/GetWebstack-public/nodejs-elysia
cd nodejs-elysia
```
...
| [nodejs-adonisjs](https://github.com/GetWebstack-public/nodejs-adonisjs) | [AdonisJS](https://adonisjs.com/) | Full-stack MVC framework for Node.js |
